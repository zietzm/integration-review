...
A different type of approach which shows promise involves extracting information from data modalities individually before combining extracted data into a single, more cohesive representation with a relatively higher signal-to-noise ratio.
...
Ritchie et al. [@doi:10.1038/nrg3868] propose (...)
